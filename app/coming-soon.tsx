...
export default function ComingSoon() {
  return (
    <main className="coming-soon-page">
      ...
      <section className="preview-section" id="preview"><div className="preview-heading"><div><p className="eyebrow">DESIGNED FOR MEMBERS</p><h2>Simple steps. Clear ownership. Visible progress.</h2></div><p>The experience is being tested for clarity, accessibility, and mobile use before member access opens.</p></div><div className="preview-grid"><article><div className="browser-frame"><div className="browser-bar"><span /><span /><span /><small>Guided request</small></div><img src="/screenshots/member-request.jpg" alt="Guided support topic selection and request form" /></div><div><strong>Guided request submission</strong><p>Plain-language categories help each request reach the right support area.</p></div></article><article><div className="browser-frame"><div className="browser-bar"><span /><span /><span /><small>Request tracking</small></div><img src="/screenshots/status-tracker.jpg" alt="KP request status tracking experience" /></div><div><strong>Progress you can see</strong><p>Members will be able to check status, ownership, and updates from one place.</p></div></article></div></section>
